...
public class DocController {
    ...
    private File imgLogo = new File("src/media/logofinal.jpg");
    private String imgLogoAbsolute = imgLogo.getAbsolutePath();
    private File imgSignature = new File("src/media/signature.jpg");
    private String imgSignatureAbsolute = imgSignature.getAbsolutePath();

    /**
     * Instanciation de la classe Créer
     */
     ...
     */
    public DocController() throws InvalidFormatException, IOException {
        ...
        */
        ...
        run2.addBreak();
        run2.setText(creer.getTitreClient());
        run2.addBreak();
        run2.setText(creer.getNomClient());
        run2.addBreak();
        run2.setText(creer.getPrenomClient());
        run2.addBreak();
        run2.addBreak();
        ...
        run4.addBreak();
        run4.addTab();
        run4.setText("Je soussigné Monsieur " + ENTREPRISE_HOLDER +  " gérant de l'organisme agréé " + ENTREPRISE_NAME + " certifie que XXXX  a bénéficié d'assistance informatique à domicile, service à la personne :");
        run4.addBreak();
        run4.addBreak();
        run4.addTab();
        run4.addTab();
